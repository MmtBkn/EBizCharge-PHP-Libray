<?php
/**
 * File for class EBizChargeStructOrderLineItem
 * @package EBizCharge
 * @subpackage Structs
 ...
 */
/**
 * This class stands for EBizChargeStructOrderLineItem originally named OrderLineItem
 ...
 * @date 2017-05-25
 */
class EBizChargeStructOrderLineItem extends EBizChargeWsdlClass
{
    /**
     * The ProductRefNum
     * Meta informations extracted from the WSDL
     ...
     * @return EBizChargeStructOrderLineItem
     */
    public function __construct($_productRefNum = NULL,$_sKU = NULL,$_commodityCode = NULL,$_productName = NULL,$_description = NULL,$_discountAmount = NULL,$_discountRate = NULL,$_unitOfMeasure = NULL,$_unitPrice = NULL,$_qty = NULL,$_taxClass = NULL,$_taxable = NULL,$_taxAmount = NULL,$_taxRate = NULL)
    {
        parent::__construct(array('ProductRefNum'=>$_productRefNum,'SKU'=>$_sKU,'CommodityCode'=>$_commodityCode,'ProductName'=>$_productName,'Description'=>$_description,'DiscountAmount'=>$_discountAmount,'DiscountRate'=>$_discountRate,'UnitOfMeasure'=>$_unitOfMeasure,'UnitPrice'=>$_unitPrice,'Qty'=>$_qty,'TaxClass'=>$_taxClass,'Taxable'=>$_taxable,'TaxAmount'=>$_taxAmount,'TaxRate'=>$_taxRate),false);
    }
    /**
