<?php
/**
 * File for class EBizChargeStructBank
 * @package EBizCharge
 * @subpackage Structs
 ...
 */
/**
 * This class stands for EBizChargeStructBank originally named Bank
 ...
 * @date 2017-05-25
 */
class EBizChargeStructBank extends EBizChargeWsdlClass
{
    /**
     * The Code
     * @var string
     ...
     * @param string $_code
     * @param string $_name
     * @return EBizChargeStructBank
     */
    public function __construct($_code = NULL,$_name = NULL)
    {
        parent::__construct(array('Code'=>$_code,'Name'=>$_name),false);
    }
    /**
     * Get Code value
     * @return string|null
