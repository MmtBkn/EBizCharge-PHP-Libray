<?php
/**
 * File for EBizChargeWsdlClass to communicate with SOAP service
 * @package EBizCharge
 ...
 */
/**
 * EBizChargeWsdlClass to communicate with SOAP service
 * Documentation : The USAePay Soap interface provides a collection of functions implementinga large portion of merchant functionality.
 * @package EBizCharge
 * @author Muhammet Bakan <mail@muhammetbakan.com>
 * @version 20150429-01
 * @date 2017-05-25
 */
class EBizChargeWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://secure.ebizcharge.com/soap/gate/246CEB5A/ebizcharge.wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses EBizChargeWsdlClass::setLastError()
     * @uses EBizChargeWsdlClass::initSoapClient()
     * @uses EBizChargeWsdlClass::initInternArrayToIterate()
     * @uses EBizChargeWsdlClass::_set()
     ...
     * @return EBizChargeWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'EBizChargeWsdlClass'))
            {
     ...
     * @uses EBizChargeClassMap::classMap()
     * @uses EBizChargeWsdlClass::getDefaultWsdlOptions()
     * @uses EBizChargeWsdlClass::getSoapClientClassName()
     * @uses EBizChargeWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('EBizChargeClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = EBizChargeClassMap::classMap();
     ...
     * If a class is named as {EBizCharge}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('EBizChargeSoapClient') && is_subclass_of('EBizChargeSoapClient','SoapClient'))
            return 'EBizChargeSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses EBizChargeWsdlClass::WSDL_CACHE_WSDL
     * @uses EBizChargeWsdlClass::WSDL_COMPRESSION
     * @uses EBizChargeWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses EBizChargeWsdlClass::WSDL_ENCODING
     * @uses EBizChargeWsdlClass::WSDL_EXCEPTIONS
     * @uses EBizChargeWsdlClass::WSDL_FEATURES
     * @uses EBizChargeWsdlClass::WSDL_LOGIN
     * @uses EBizChargeWsdlClass::WSDL_PASSWORD
     * @uses EBizChargeWsdlClass::WSDL_SOAP_VERSION
     * @uses EBizChargeWsdlClass::WSDL_STREAM_CONTEXT
     * @uses EBizChargeWsdlClass::WSDL_TRACE
     * @uses EBizChargeWsdlClass::WSDL_TYPEMAP
     * @uses EBizChargeWsdlClass::WSDL_URL
     * @uses EBizChargeWsdlClass::VALUE_WSDL_URL
     * @uses EBizChargeWsdlClass::WSDL_USER_AGENT
     * @uses EBizChargeWsdlClass::WSDL_PROXY_HOST
     * @uses EBizChargeWsdlClass::WSDL_PROXY_PORT
     * @uses EBizChargeWsdlClass::WSDL_PROXY_LOGIN
     * @uses EBizChargeWsdlClass::WSDL_PROXY_PASSWORD
     * @uses EBizChargeWsdlClass::WSDL_LOCAL_CERT
     * @uses EBizChargeWsdlClass::WSDL_PASSPHRASE
     * @uses EBizChargeWsdlClass::WSDL_AUTHENTICATION
     * @uses EBizChargeWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses EBizChargeWsdlClass::getSoapClient()
     * @uses EBizChargeWsdlClass::getFormatedXml()
     ...
     * @uses EBizChargeWsdlClass::getSoapClient()
     * @uses EBizChargeWsdlClass::convertStringHeadersToArray()
     ...
     * @uses EBizChargeWsdlClass::count()
     * @return int
     */
     ...
     * @uses EBizChargeWsdlClass::getInternArrayToIterate()
     * @uses EBizChargeWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses EBizChargeWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses EBizChargeWsdlClass::getInternArrayToIterateOffset()
     * @uses EBizChargeWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses EBizChargeWsdlClass::getInternArrayToIterateOffset()
     * @uses EBizChargeWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see EBizChargeWsdlClass::offsetGet()
     * @uses EBizChargeWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses EBizChargeWsdlClass::getAttributeName()
     * @uses EBizChargeWsdlClass::__toString()
     * @uses EBizChargeWsdlClass::_set()
     * @uses EBizChargeWsdlClass::_get()
     * @uses EBizChargeWsdlClass::setInternArrayToIterate()
     * @uses EBizChargeWsdlClass::setInternArrayToIterateIsArray()
     * @uses EBizChargeWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses EBizChargeWsdlClass::item()
     * @uses EBizChargeWsdlClass::length()
     * @return mixed
     */
